<head>
    <meta charset="utf-8"/>
    <title>Aplicación Baixens - Laboratorio</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/plugins/bootstrap-fileinput/bootstrap-fileinput.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ url('assets/plugins/bootstrap-switch/css/bootstrap-switch.min.css') }}"/>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/plugins/typeahead/typeahead.css') }}">
    ...
    <script type="text/javascript">
        var esBaseHija = false;
        var editando = false;
        var esNewBaseHija = false;
        var editingBase = false;
        var availableProductCodes=[];
    </script>
</head>