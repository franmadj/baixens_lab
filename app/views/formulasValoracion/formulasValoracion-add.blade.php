				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
								...
								<tr>
                                    ...
                                    <th>
										 Porcentaje
                                                                        ...
                                                                        <th><button type="button" id="uno-mas" class="btn green">+</button></th>
                                        ...
                                        <input name="det-codigo-1" id="codigo-1" {{ (Input::old('det-codigo-1')) ? 'value="'.Input::old('det-codigo-1').'"' : '' }} class="form-control codigo cojones" type="text"  placeholder="Sale de calculo" tabindex="3">
									</td>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Peso fórmula (Kg)</label>
									<div class="col-md-10">
                          ...
                          <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Precio (€/Kg)</label>
									<div class="col-md-10">
                        ...
                        <div class="form-group">
									<div class="col-md-12">
                                                                            <button type="submit" id="guardar" class="btn btn-success send-formula">Guardar</button>
									</div>
						</div>
