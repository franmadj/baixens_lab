            ...
            <div class="portlet-body">
                ...
                <form action="{{URL::to('add-formula-valoracion')}}" class="form-horizontal" method="post" role="form">
                                ...
                                <tbody id="append">
                                    <tr id="aClonar" style="display: none;">
                                        ...
                                        <td class="td_codigo">
                                            ...
                                            <input name="det-codigo-1" id="codigo-1" {{ (Input::old('det-codigo-1')) ? 'value="'.Input::old('det-codigo-1').'"' : '' }} class="form-control codigo cojones" type="text" readonly=""  placeholder="Sale de calculo" tabindex="3">
                                        </td>

                                        <td class="td_cantidad">
                                            <input tabindex="4" name="det-cantidad-1" {{ (Input::old('det-cantidad-1')) ? 'value="'.Input::old('det-cantidad-1').'"' : '' }} type="text" class="form-control cantidad" readonly="" placeholder="Cantidad">
                                        </td>
                    ...
                    <div class="col-md-12"  style="padding:0px;">
                        <a type="submit" target="_blank" href="{{URL::to('ver-pdf-formula-valoracion')}}/{{$formula->id}}" class="btn red btn-block">PDF</a>
