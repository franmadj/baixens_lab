    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form class="form-horizontal" method="post" id="formula_form" role="form" action="{{ URL::to('add-formula-sate') }}">
...
<script>
            ...
            $('#bases').change(function(){
                ...
                window.location="{{ URL::to('add-formula-base-hija-sate') }}/"+$(this).val();
