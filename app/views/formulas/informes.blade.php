...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<a class="navbar-brand" href="index.html" >
			<img src="img/logo.png" alt="logo" height="20px;" class=""/>
		</a>
		<!-- END LOGO -->
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="ver-proveedores.html">
								<i class="fa fa-eye"></i>
								Ver
							</a>
						</li>
						<li>
							<a href="add-proveedores.html">
                ...
                <li>
					...
					<ul class="sub-menu">
						<li>
							<a href="ver-productos.html">
								<i class="fa fa-eye"></i>
								Ver
							</a>
						</li>
						<li>
							<a href="add-productos.html">
								<i class="fa fa-pencil"></i>
								Insertar
							</a>
						</li>
                ...
                <li>
					...
					<ul class="sub-menu">
						<li>
							<a href="ver-pedidos.html">
								<i class="fa fa-eye"></i>
								Ver
							</a>
						</li>
						<li>
							<a href="add-pedidos.html">
								<i class="fa fa-pencil"></i>
								Insertar
							</a>
						</li>
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="ver-formula.html">
								<i class="fa fa-eye"></i>
								Ver
							</a>
						</li>
						<li>
							<a href="add-formula.html">
								<i class="fa fa-pencil"></i>
								Insertar
							</a>
						</li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
                            <a  href="add-pedidos.html" class="btn blue">
				...
				<div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                                <form class="form-horizontal col-md-12" role="form" style="padding:0px; margin-bottom:20px;">
                                 ...
                                 <p>Nota: Antes de cambiar el producto tendras que crearlo.</p>
                         </div>
                    </div>
						...
						<div class="portlet-body">
                                ...
                                <form class="form-horizontal col-md-12" role="form" style="padding:0px; margin-bottom:20px;">
                                    ...
                                    <div class="col-md-3" style="padding:0px;">
                                        <input type="text" class="form-control" id="inputEmail1" placeholder="Código producto">
                                    </div>
                                    <div class="col-md-3">
                                       <button type="submit" class="btn red btn-block">Filtrar</button>
                                    </div>
                                    <div class="col-md-3">
                                       <a type="submit" target="_blank" href="impresiones/impresion-informe.html" class="btn green btn-block">Imprimir</a>
                                    </div>
                                    <div class="col-md-3">
                                       <button type="submit" class="btn btn-info btn-block">Editar</button>
                                    </div>
