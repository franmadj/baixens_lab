                                ...
                                <tbody id="append" >
                                    ...
                                    <tr id="aClonar" style="display:none;">
                                        ...
                                        <td class="td_color">
                                            ...
                                            <input name="det-color-1" id="color-1" {{ (Input::old('det-color-1')) ? 'checked="checked"':'' }} style="opacity:1;" tabindex="-1" class="form-control color noUniform toggle" data-no-uniform="true" type="checkbox" value="1" >
