        ...
        <div class="contenedor">
            ...
            <table style="margin-top:20px; text-align:center;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="right"><span class="texto"><?php
                                if (isset($formDet->Producto->codigo)) {
                                    echo $formDet->Producto->codigo;
                                }
                                ?></span></td>
                        <td class="left"><span class="texto"><?php
                                if (isset($formDet->Producto->nombreProducto)) {
                                    echo $formDet->Producto->nombreProducto;
                                }
                                ?></span></td>
